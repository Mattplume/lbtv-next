...
async function VideosList() {
	try {
		const data = await getFacebookVideos("1508652705876539");
		...
		return (
			<div className="bg-red-100 text-red-700 p-4 rounded-md text-center">
				❌ Impossible de récupérer les vidéos des émissions. Veuillez réessayer
				plus tard.
			</div>
		);
	}
...
export default function NewsPage() {
	return (
		<div className="container mx-auto p-4 min-h-screen">
			<h1 className="text-3xl font-bold mb-6">Les Émissions</h1>
